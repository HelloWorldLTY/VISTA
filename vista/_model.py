...
class GIMVI_GCN(VAEMixin, BaseModelClass):
    ...
    **model_kwargs
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        self.adata_spatial_raw = adata_spatial.copy()
        ...
        self.module = JVAE(
            ...
            spatial_data = self.adata_spatial_raw,
    ...
    def setup_anndata(
        ...
        **kwargs,
        ...
        anndata_fields = [
            ...
            CategoricalObsField(REGISTRY_KEYS.INDICES_KEY, obs_names)
        ]
